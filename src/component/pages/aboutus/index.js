        ...
        <div className="row g-5 align-items-center">
              ...
              <div className="modal-dialog">
                <div className="modal-content rounded-0">
                  ...
                  <div className="modal-body">
                    <div className="ratio ratio-16x9" style={{ position: "relative", paddingTop: "56.25%", width: "100%", height: "100%" }}>
                      {/* Instagram Embed */}
                      <blockquote
          ...
          <div className="col-lg-7 wow fadeIn" data-wow-delay="0.3s">
            ...
            <p>
              ...
              the period of pregnancy, to the time of delivery into a new world
              and finally to the point of exit to a better world. Montessori
              education believes and allows children to develop according to
              their inner laws of development so that they can produce a more
            ...
            <p>
              ...
              study environment for our pupils. At JoyfulNestle, our pupils have
              interpersonal contacts with the Class Directress whose role is to
              observe and respond appropriately to the needs of individual pupil
              in a group while also directing the whole group.
            </p>
            <p className="fw-bold">
