            ...
            {BlogPosts.map((post, index) => (
              ...
              >
                <div className="blog-item rounded-bottom">
                  ...
                  <div
                    className="d-flex justify-content-between px-4 py-3 blog-date-comments"
                    style={{
                  ...
                  <div
                    className="blog-content d-flex align-items-center px-4 py-3"
                    style={{ backgroundColor: "#00ecf4" }}
                  >
                    <div
                      className="overflow-hidden rounded-circle rounded-top"
                      style={{ color: "#000000", border: "1px solid #000000" }}
                    >
                      <i
                        className="fas fa-user fs-1 rounded-circle text-center p-2 rounded-top"
                        style={{
                          width: "70px",
                          height: "70px",
                          borderStyle: "dotted",
                  ...
                  <div
                    className="px-4 pb-4 rounded-bottom"
                    style={{ backgroundColor: "#00ecf4", color: "#000000" }}
                  >
                    <div className="blog-text-inner">
                      <a href="#" className="h4">
                        {post.title}
                      </a>
                      <p className="mt-3 mb-4" style={{ color: "#000000" }}>
                        {post.description}
                      </p>
                    </div>
                    <div className="text-center">
                      <Link to={`/blog/${post.slug}`}>
                        <button
                          className="btn px-4 py-2 mb-3 btn-border-radius text-uppercase fw-bold fs-6"
                          style={{
